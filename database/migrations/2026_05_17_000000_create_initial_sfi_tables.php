...
return new class extends Migration
{
    ...
    {
        // Create Departments
        if (!Schema::hasTable('sfi_mysql_tb_r_departments')) {
        ...
        // Create Ideas table
        if (!Schema::hasTable('sfi_mysql_tb_t_ideas')) {
        ...
        if (!Schema::hasTable('sfi_mysql_tb_t_idea_scores')) {
        ...
        if (!Schema::hasTable('sfi_mysql_tb_t_review_logs')) {
